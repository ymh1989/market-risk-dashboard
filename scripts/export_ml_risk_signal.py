    ...
    payload = {
        ...
        "metrics": {
            ...
            "downside5d": {
                ...
                "averagePrecision": _metric(metrics, "ml_selected", "downside_5d", "average_precision"),
                "eventRate": _metric(metrics, "ml_selected", "downside_5d", "event_rate"),
                "topDecileHitRate": _metric(metrics, "ml_selected", "downside_5d", "top_decile_hit_rate"),
                "topDecileLift": _metric(metrics, "ml_selected", "downside_5d", "top_decile_lift"),
            ...
            "downside20d": {
                ...
                "averagePrecision": _metric(metrics, "ml_selected", "downside_20d", "average_precision"),
                "eventRate": _metric(metrics, "ml_selected", "downside_20d", "event_rate"),
                "topDecileHitRate": _metric(metrics, "ml_selected", "downside_20d", "top_decile_hit_rate"),
                "topDecileLift": _metric(metrics, "ml_selected", "downside_20d", "top_decile_lift"),
        ...
        "thresholds": {
            ...
            "downside5dReturnPct": round(float(bundle.config.get("downside", {}).get("return_threshold_5d", -0.03)) * 100, 2),
            "downside20dReturnPct": round(float(bundle.config.get("downside", {}).get("return_threshold_20d", -0.05)) * 100, 2),
        },
        "interpretation": [
            ...
            "급락확률은 변동성 조건을 제외하고 KOSPI가 5일 -3% 또는 20일 -5% 이하로 하락할 가능성만 별도로 추정합니다.",
        ],
