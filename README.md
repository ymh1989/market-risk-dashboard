...
홈페이지의 `금리·환율·원자재·운임 방향성` 패널은 `data/naver-marketindex-history.json`을 읽어 미국·한국 금리, USD/JPY·USD/CNY, 에너지·금속, 해상운임의 최근 약 3개월 흐름을 보여줍니다. 금리는 1주·1개월 변화를 bp로, 나머지 자산은 수익률로 표시하며, 최근 일간 10회 또는 주간 6회의 상승·하락 빈도로 방향 지속성을 판독합니다. USD/JPY 상승은 엔화 약세, 하락은 엔화 강세로 해석합니다.
