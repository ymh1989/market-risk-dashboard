...
`오늘의 예약 실행`은 평일 세 차례와 토요일 아침 한 차례 작업을 완료·진행 중·지연·예정으로 나누어 보여줍니다. 완료된 작업은 완료시각과 실제 소요시간을, 예정 작업은 시작까지 남은 시간을 표시합니다. 최근 성공 이력의 전체 갱신·빠른 갱신 중앙 소요시간을 함께 제공해 평소보다 느린 실행을 판단할 수 있습니다. 예약이 없는 일요일에는 다음 월요일 예약을 대신 보여줍니다.
