...
대시보드는 현재 상태와 의사결정에 필요한 지표를 먼저 배치하고, 백테스트와 과거 스트레스 사례는 각 화면의 하단에 둡니다. 관련 정보는 불필요한 중첩 테두리보다 여백과 정렬로 묶고, 상태색에는 항상 등급·방향 텍스트를 함께 표시합니다. 본문은 왼쪽 정렬과 1.5배 이상의 행간을 사용하며, 글꼴 굵기는 일반과 굵게 두 단계로 제한합니다. 키보드 포커스, 밝은·어두운 테마 대비와 모션 감소 설정도 동일한 화면 구조에서 지원합니다.
