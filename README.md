...
시장리스크와 ELS 발행·헤지 환경을 함께 점검하는 정적 대시보드입니다. 시장 종합점수에 반영되는 18개 가중지표와 연구용 관찰지표 3개, 스트레스 사례, KOSPI ML risk-off 신호, SPX·SX5E·NKY·HSCEI·KOSPI200 ELS 리스크를 한 화면에서 확인할 수 있습니다. 별도 프런트엔드 빌드 도구 없이 `index.html`, `src/*`, `data/*.json`으로 실행되며, 신용리스크와 유동성리스크를 같은 구조로 확장할 수 있습니다.
...
- 연구 관찰카드: USD/JPY·VIX·SPX의 엔 캐리 청산 압력, 한국 3년-미국 2년 금리차·USD/KRW의 원화 압력, 미국 10년-일본 10년 금리차의 5·20개 관측치 축소 압력을 0~100점으로 표시합니다. 세 카드는 가중치 0으로 종합점수·위험군 점수·고위험 지표 수에서 제외합니다.
